...
const MovieHero = () => {
  ...
  return <>
    <div>
        {/* Mobile and Tab Screen i.e., small ans medium screen size */}
        <div className="lg:hidden w-full">
            <img src = {`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt = "cover poster" className="px-4 rounded" style = {{width:"calc(100%-2rem)"}} />
        </div>
